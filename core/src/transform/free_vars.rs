...
impl RemoveBindings for OrPattern {
    fn remove_bindings(&self, working_set: &mut HashSet<Ident>) {
        ...
        // branch in an or patterns should bind exactly the same variables. However, at the
        // time of writing, this condition isn't enforced at parsing type (it's enforced
